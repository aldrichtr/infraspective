...
online version: https://github.com/aldrichtr/infraspective/blob/main/docs/help/AuditPolicy.md
schema: 2.0.0
---
...
```
AuditPolicy [-Qualifier] <String> [-Target] <String> [-Should] <ScriptBlock> [<CommonParameters>]
```
