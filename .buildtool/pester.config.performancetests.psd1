@{
    ...
    TestResult   = @{
        ...
        # Default = 'NperformanceXml'
        # Description = 'Format to use for test result report. Possible values: NperformanceXml, Nperformance2.5 or JperformanceXml'
        OutputFormat   = 'NperformanceXml'
