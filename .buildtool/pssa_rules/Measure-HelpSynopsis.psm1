function Measure-HelpSynopsis {
    <#
    .SYNOPSIS
        Confirm the function has a help synopsis
    .DESCRIPTION
        ...
        To fix a violation of this rule, add a .SYNOPSIS keyword in your comment-based help. You can get more details by running “Get-Help about_Comment_Based_Help” command in Windows PowerShell.
    .EXAMPLE
    ...
    Process {
        ...
        try {
            ...
            if (!$FunctionDefinitionAst.GetHelpContent().Synopsis) {
                $result = [Microsoft.Windows.PowerShell.ScriptAnalyzer.Generic.DiagnosticRecord]@{
                    Message  = "Function should have a Synopsis section"
                    RuleName = 'AdvancedFunctionHelpSynopsis'
                    Severity = 'Error'
