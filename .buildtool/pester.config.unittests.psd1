@{
    ...
    Filter       = @{
        ...
        # Default = @()
        # Description = 'Filter by file and scriptblock start line, useful to run parsed tests programatically
        # to avoid problems with expanded names. Example: ''C:\tests\file1.Tests.ps1:37'''
        Line        = @()
        ...
        # Default = @()
        # Description = 'Full name of test with -like wildcards, joined by dot.
    ...
    CodeCoverage = @{
        ...
        # Default = @()
        # Description = 'Directories or files to be used for codecoverage, by # Default the Path(s) from
        # general settings are used, unless overridden here.'
        Path                  = @()
        ...
        # Default = $true
        # Description = 'EXPERIMENTAL: When false, use Profiler based tracer to do CodeCoverage
    ...
    TestResult   = @{
        ...
        OutputPath     = 'out/unit_test_results.nunit.xml'
    ...
    Should       = @{
        # Default = 'Stop'
        # Description = 'Controls if Should throws on error. Use ''Stop'' to throw on error, or ''Continue'' to fail
    ...
    Debug        = @{
        # Default = $false
        # Description = 'Show full errors including Pester internal stack. This property is deprecated, and if set
        ...
        #    'CodeCoverage'
        # )
        # Description = 'Write Debug messages from a given source, WriteDebugMessages must be set to true for this
        ...
        # Default = $false
        # Description = 'Returns unfiltered result object, this is for development only. Do not rely on this object
    ...
    Output       = @{
        ...
        # Default = 'Auto'
        # Description = 'The CI format of error output in build logs, options are None, Auto, AzureDevops and
        # GithubActions.'
